...
def cuestionario_ipaq():
    ...
    # Actividades físicas vigorosas
    st.subheader("Actividades Físicas Vigorosas")
    dias_vigorosa = st.number_input# Función para el cuestionario de Calidad del Sueño
def cuestionario_calidad_sueno():
    st.title("Evaluación de la Calidad del Sueño - Índice de Pittsburgh")
    st.write("Responde las siguientes preguntas sobre tus hábitos de sueño durante el último mes:")
...
def cuestionario_ipaq():
    ...
    st.subheader("Actividades Físicas Vigorosas")
    dias_vigorosa = st.number_input(
        "1. Durante los últimos 7 días,# Función para el cuestionario de Calidad del Sueño
def cuestionario_calidad_sueno():
    st.title("Evaluación de la Calidad del Sueño - Índice de Pittsburgh")
    st.write("Responde las siguientes preguntas sobre tus hábitos de sueño durante el último mes:")
...
def cuestionario_ipaq():
    ...
    # Actividades físicas vigorosas
    st.subheader("Actividades Físicas Vigorosas")
    dias_vigorosa = st.number_input ¿en cuántos días realizaste actividades físicas vigorosas como levantar objetos pesados, cavar, aeróbicos o andar en bicicleta rápido? (Días por semana)", 
        min_value=0, max_value=7, step=1
    )
    if dias_vigorosa > 0:
        tiempo_vigorosa_horas = st.number_input(
    ...
    if st.button("Calcular Puntuación"):
        ...
        if total_met >= 3000:
            ...
            st.warning("Nivel de actividad: Baja. Considera realizar más actividades físicas para mejorar.")urante los últimos 7 días, ¿en cuántos días caminaste al menos 10 minutos seguidos? (Días por semana)", 
        min_value=0, max_value=7, step=1
    )
    if dias_caminata > 0:
        tiempo_caminata_horas = st.number_input(
