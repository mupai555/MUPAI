...
# ==================== PÁGINA ¿QUIÉNES SOMOS? ====================
    ...
    st.markdown('''
    <div style="background: linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 100%); padding: 4rem 3rem; border-radius: 25px; margin: 2rem 0; border: 3px solid #FFCC00; box-shadow: 0 8px 30px rgba(255,204,0,0.3);">
        
        <div style="margin-bottom: 4rem;">
            <h2 style="color: #FFCC00; font-size: 2.5rem; font-weight: bold; margin-bottom: 2rem; text-align: center; text-shadow: 2px 2px 4px rgba(255,204,0,0.3); border-bottom: 3px solid #FFCC00; padding-bottom: 1rem;">
                🎯 Nuestra Misión
            </h2>
        ...
        <div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem; margin-top: 2rem;">
                <div style="background: rgba(255,204,0,0.15); padding: 2rem; border-radius: 15px; border-left: 4px solid #FFCC00; transition: transform 0.3s ease; box-shadow: 0 4px 15px rgba(255,204,0,0.1);">
