...
• Proteína: {proteinas_g_ajustadas:.0f}g ({proteinas_kcal_ajustadas:.0f} kcal) - {proteinas_kcal_ajustadas/calorias_totales100:.0f}%
Factor aplicado: {factor_proteina:.1f}g/kg peso corporal
• Grasas: {grasas_g_ajustadas:.0f}g ({grasas_kcal_ajustadas:.0f} kcal) - {grasas_kcal_ajustadas/calorias_totales100:.0f}%
