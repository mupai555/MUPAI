...
menu = st.sidebar.selectbox(
    "Select a section:",
    ["Home", "Genetic Potential Questionnaire", "Perceived Stress Questionnaire", "Sleep Quality Questionnaire (PSQI)"],
)
...
# Perceived Stress Questionnaire (PSS)
    ...
    with st.form("PSS Form"):
        ...
        submitted = st.form_submit_button("Submit PSS Responses")
        if submitted:
...
# Sleep Quality Questionnaire (PSQI)
    ...
    with st.form("PSQI Form"):
        ...
        submitted = st.form_submit_button("Submit PSQI Responses")
        if submitted:
