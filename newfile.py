...
# La función principal mostrar_body_and_energy() está definida más adelante
...
def load_mup_logo_image_base64():
    """
...
def mostrar_body_and_energy():
    ...
    :root {{
        ...
        --gradient-tech: linear-gradient(135deg, #00D4FF 0%, #0099CC 100%);
        
        /* Shadows */
        --shadow-soft: 0 4px 20px rgba(255, 204, 0, 0.1);
        --shadow-medium: 0 8px 32px rgba(255, 204, 0, 0.15);
        --shadow-strong: 0 12px 48px rgba(255, 204, 0, 0.25);
    ...
    .header-container {{
        ...
        border-radius: 24px;
        margin-bottom: 3rem;
        box-shadow: var(--shadow-medium), inset 0 1px 0 rgba(255,204,0,0.1);
    ...
    .content-card h2, .content-card h3 {{
        color: var(--mupai-primary) !important;
        font-weight: 700;
        margin-bottom: 1.5rem;
    ...
    .stButton > button:hover {{
        ...
        background: linear-gradient(135deg, #FFE55C 0%, #FFCC00 50%, #DAA520 100%) !important;
    }}
    ...
    .stTextInput > div > div > input {{
        background: var(--tech-medium) !important;
    ...
    .badge-success {{
        background: linear-gradient(135deg, var(--tech-success) 0%, #00CC70 100%);
        color: var(--tech-darker);
    }}
    
    .badge-warning {{
        background: linear-gradient(135deg, var(--tech-warning) 0%, #E55A29 100%);
        color: white;
    }}
    ...
    if not st.session_state.body_energy_authenticated:
        ...
        <div class="auth-container">
            ...
            <p class="auth-subtitle">
                Sistema de evaluación profesional Body & Energy<br>
                Ingresa la contraseña de acceso autorizado
            </p>
        </div>
        """, unsafe_allow_html=True)
        ...
        with login_container:
            ...
            with col2:
                ...
                if st.button("🚀 Acceder al Sistema MUPAI", use_container_width=True, key="body_energy_login"):
        ...
        # Mostrar información tecnológica mientras no esté autenticado
        st.markdown("""
        <div class="content-card" style="margin-top: 3rem; text-align: center;">
            <h3 style="color: var(--mupai-primary); font-size: 1.8rem; margin-bottom: 1.5rem;">
                🧬 Sistema de Evaluación Fitness Profesional
            </h3>
            <p style="color: rgba(255,255,255,0.85); font-size: 1.1rem; line-height: 1.6; margin-bottom: 2rem;">
                MUPAI utiliza <strong>algoritmos científicos avanzados</strong> y <strong>inteligencia artificial</strong> 
                para proporcionar evaluaciones personalizadas de composición corporal, rendimiento físico 
                y planificación nutricional basada en evidencia.
            </p>
            <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 1rem; margin-bottom: 2rem;">
                <span class="badge badge-primary">📊 Análisis Científico</span>
                <span class="badge badge-success">🧬 IA Personalizada</span>
                <span class="badge badge-warning">⚡ Resultados Instantáneos</span>
            </div>
            <p style="color: rgba(255,255,255,0.6); font-size: 0.95rem; margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid rgba(255,204,0,0.2);">
                © 2025 MUPAI - Muscle up GYM<br>
                <strong>Digital Training Science • Performance Assessment Intelligence</strong>
            </p>
        </div>
        """, unsafe_allow_html=True)
    ...
    # ==================== CUESTIONARIO PRINCIPAL MODERNIZADO ====================
    
    # Función de tarjetas modernizada
    def crear_tarjeta(titulo, contenido, tipo="info"):
        colores = {
            "info": "var(--mupai-primary)",
            "success": "var(--tech-success)",
            "warning": "var(--tech-warning)",
            "danger": "var(--tech-danger)"
        }
        color = colores.get(tipo, "var(--mupai-primary)")
        
        # Iconos modernos según el tipo
        iconos = {
            "info": "🎯",
            "success": "✨",
            "warning": "⚡",
        ...
        <div class="content-card">
            <div style="display: flex; align-items: center; margin-bottom: 1.5rem;">
                <span style="font-size: 2rem; margin-right: 1rem; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.3));">
                    {icono}
                </span>
                <h3 style="margin: 0; color: {color}; font-weight: 700; font-size: 1.3rem;">
                    {titulo}
                </h3>
            </div>
            <div style="color: rgba(255,255,255,0.85); line-height: 1.6; font-size: 1.05rem;">
                {contenido}
            </div>
        </div>
        """

    # Misión, Visión y Compromiso con diseño tecnológico mejorado
    with st.expander("🚀 **Filosofía y Valores MUPAI**", expanded=False):
        st.markdown("""
        <style>
        .philosophy-grid {
            display: grid;
        ...
        with col1:
            st.markdown(crear_tarjeta(
                "Misión",
                "Hacer accesible el <strong>entrenamiento basado en ciencia</strong>, ofreciendo planes personalizados que se adaptan a todos los niveles de condición física mediante tecnología avanzada.",
                "info"
            ), unsafe_allow_html=True)
        with col2:
            st.markdown(crear_tarjeta(
                "Visión",
                "Ser el <strong>referente global</strong> en evaluación y entrenamiento digital personalizado, uniendo investigación científica con experiencia práctica e inteligencia artificial.",
                "success"
            ), unsafe_allow_html=True)
        with col3:
            st.markdown(crear_tarjeta(
                "Compromiso",
                "Nos guiamos por la <strong>ética, transparencia y precisión científica</strong> para ofrecer resultados reales, medibles y sostenibles a cada cliente.",
                "warning"
            ), unsafe_allow_html=True)
        
        st.markdown("</div>", unsafe_allow_html=True)

    # BLOQUE 0: Datos personales con diseño tecnológico mejorado
    st.markdown("""
    <div class="content-card">
        <div style="display: flex; align-items: center; margin-bottom: 2rem;">
            ...
            <div>
                ...
                <p style="margin: 0.5rem 0 0 0; color: rgba(255,255,255,0.8); font-size: 1rem;">
                    Complete todos los campos para comenzar su evaluación personalizada
                </p>
            </div>
        </div>
    """, unsafe_allow_html=True)
...
mup_logo_base64_footer = load_mup_logo_image_base64()

# Create MUPAI logo HTML (left side)
if logo_base64_footer:
    mupai_logo_html = f'<img src="{logo_base64_footer}" style="width: 120px; height: 120px; object-fit: contain;">'
else:
    mupai_logo_html = '<div style="width: 120px; height: 120px; background-color: #ffcc00; display: flex; align-items: center; justify-content: center; color: #000; font-weight: bold; font-size: 2rem;">MUPAI</div>'

# Create Muscle Up Gym logo HTML (right side)
if mup_logo_base64_footer:
    mup_logo_html = f'<img src="{mup_logo_base64_footer}" style="width: 120px; height: 120px; object-fit: contain;">'
else:
    mup_logo_html = '<div style="width: 120px; height: 120px; background-color: #ffcc00; display: flex; align-items: center; justify-content: center; color: #000; font-weight: bold; font-size: 1.5rem;">MUP</div>'
...
<div style="padding: 2rem; background: linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 100%); border-radius: 10px; border: 1px solid #FFCC00;">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; margin-bottom: 1.5rem;">
        ...
        <!-- Muscle Up Gym Logo (Right) -->
        <div style="flex: 0 0 auto;">
            {mup_logo_html}
        </div>
    </div>
    
    <!-- Mobile responsive fallback: stack logos vertically on small screens -->
    <style>
        @media (max-width: 768px) {{
            .footer-container {{
                flex-direction: column !important;
